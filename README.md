...
- **Firefox alapú: _[Letöltés itt](https://addons.mozilla.org/en-US/firefox/addon/magyaranimetweaks/)_** (Firefox Add-ons)
- **Chromium alapú: _[Letöltés itt](https://chromewebstore.google.com/detail/magyaranimetweaks/kpaljcmdlnbnebockdplokocfgegiaia)_** (Chrome Web Store)

...
import {FaExclamationTriangle, FaFileAlt, FaPlayCircle} from "react-icons/fa";
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) => {
                                    const updatedSetting = { ...settings.advanced, consoleLog: checked }
                    ...
                    <CardContent>
                        <div className="space-y-4">
                             <p className="text-xs text-[#fff]/70">
                                Ez a beállítás engedélyezi, hogy az üzenetek megjelenjenek a konzolon, ezek hasznosak lehetnek hibakereséshez.
                            </p>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-[#0a0e17] border-[#205daa]/20 rounded-lg shadow-md p-1 hover:shadow-lg transition-shadow duration-300 ease-in-out w-full">
                    <CardHeader className="pb-3">
                        <div className="flex items-center gap-4">
                            ...
                            <CardTitle className="text-white text-lg font-medium">Lejátszó típusa</CardTitle>
                        </div>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-3">
                            <div className="text-sm text-gray-400">Válaszd ki a használni kívánt videó lejátszót</div>
                            <Select
                            ...
                            >
                                ...
                                <SelectContent className="bg-[#1a1f2e] border-[#205daa]/20">
                                    <SelectItem value="plyr" className="text-white hover:bg-[#205daa]/20">
                                        Plyr (Ajánlott)
                                    </SelectItem>
                                    <SelectItem value="default" className="text-white hover:bg-[#205daa]/20">
                                        Alapértelmezett
                                    </SelectItem>
                                </SelectContent>
                            </Select>
                            <div className="mt-3 p-2 bg-[#1a1f2e] border border-yellow-500/20 rounded-md">
                                <div className="flex items-start gap-2">
                                    ...
                                    <div className="text-xs text-yellow-200">
                                        Ha az <code className="bg-[#0a0e17] px-1 py-0.5 rounded">Alapértelmezett</code> lejátszót választod,
                                        akkor tulajdonképpen kikapcsolod a MATweaks bővitményét.
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <Card className="bg-[#0a0e17] border-[#205daa]/20 rounded-lg shadow-md p-1 hover:shadow-lg transition-shadow duration-300 ease-in-out w-full h-full">
                    <CardHeader className="pb-3">
                        <div className="flex items-center gap-4">
                            ...
                            <CardTitle className="text-white text-lg font-medium">Letöltés fájlnév sablon</CardTitle>
                        </div>
                    </CardHeader>
                    <CardContent className="h-full">
                        <div className="space-y-4 h-full flex flex-col">
                            <div className="text-sm text-gray-400">
                                Testreszabhatod a letöltött fájlok nevét az alábbi változók használatával
                            </div>
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    const updatedSetting = { ...settings.advanced, downloadName: e.target.value }
                                    onSettingChange("advanced", updatedSetting)
                                }}
                            ...
                            <div className="flex-1 p-3 bg-[#1a1f2e] border border-[#205daa]/20 rounded-md">
                                <div className="text-sm font-medium text-white mb-3">Elérhető változók:</div>
                                <div className="space-y-2 text-gray-400">
                                    <div className="flex items-center gap-2">
                                        <code className="bg-[#0a0e17] px-2 py-1 rounded text-xs">%title%</code>
                                        <span>Anime címe</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <code className="bg-[#0a0e17] px-2 py-1 rounded text-xs">%episode%</code>
                                        <span>Epizód száma</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <code className="bg-[#0a0e17] px-2 py-1 rounded text-xs">%0episode%</code>
                                        <span>Epizód száma nullával (pl. 01, 02)</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <code className="bg-[#0a0e17] px-2 py-1 rounded text-xs">%MAT%</code>
                                        <span>"MATweaks" szöveg</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <code className="bg-[#0a0e17] px-2 py-1 rounded text-xs">%source%</code>
                                        <span>Video forrás neve (pl. Indavideo)</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <code className="bg-[#0a0e17] px-2 py-1 rounded text-xs">%quality%</code>
                                        <span>Videó minősége (pl. 720p)</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <code className="bg-[#0a0e17] px-2 py-1 rounded text-xs">%group%</code>
                                        <span>Fansub csoport neve (ha több van, akkor vesszővel elválasztva, ha nincs, akkor "Ismeretlen")</span>
                                    </div>
                                </div>
                            </div>
                        </div>

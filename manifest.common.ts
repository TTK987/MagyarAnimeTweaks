...
export const commonManifest: ManifestV3Export = {
    name: `${packageData.displayName || packageData.name}`,
    description: packageData.description,
    version: packageData.version,
    manifest_version: 3,
    permissions: ['storage', 'contextMenus', 'downloads', 'declarativeNetRequest', 'unlimitedStorage', 'alarms'],
    host_permissions: [
        '*://*.magyaranime.eu/*',
        '*://*.magyaranime.hu/*',
        '*://*.indavideo.hu/*',
        ...
        '*://*.rumble.com/embed/*',
        '*://*.videa.hu/player*',
        // btw I forgot to remove these before publishing a version... xd
        // But in later versions, they will be needed anyway, so... I'll just leave them here
